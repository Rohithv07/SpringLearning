...
import com.spring.app.Customer;
...
public class MemberShip {
    ...
    MemberShip(int membershipId, String membershipType, int visitsPerYear, Customer customer){
    ...
    public void setMembershipId(String membershipType) {
        this.membershipType = membershipType;
    }
